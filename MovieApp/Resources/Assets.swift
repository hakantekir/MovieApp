...
internal enum Asset {
  ...
  internal enum Colors {
    ...
    internal static let whiteTwo = ColorAsset(name: "whiteTwo")
  }
  internal enum Icons {
  ...
  internal enum Images {
    internal static let image = ImageAsset(name: "Image")
    internal static let actorIcon = ImageAsset(name: "actorIcon")
    internal static let alertTopImage = ImageAsset(name: "alertTopImage")
    internal static let calendar = ImageAsset(name: "calendar")
    internal static let heart = ImageAsset(name: "heart")
    internal static let heartRed = ImageAsset(name: "heartRed")
    internal static let iconMiniSearch = ImageAsset(name: "iconMiniSearch")
    internal static let illustrationSearch = ImageAsset(name: "illustrationSearch")
